...
from homePage.decorators import staff_member_required, StaffRequiredMixin


class ItemDashboardView(StaffRequiredMixin, ListView):
    model = Item
...
class ItemCreateView(StaffRequiredMixin, CreateView):
    model = Item
    form_class = ItemForm
